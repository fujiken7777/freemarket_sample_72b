...
- 決済完了後のsold outの表示、該当商品を購入できないようにする
- バリデーション、テストの記述
- マークアップ(haml、scss、javascript)
![buy mov](https://user-images.githubusercontent.com/61724976/80278004-e5fc0b80-872d-11ea-939e-b65e90dc7d1b.gif)
